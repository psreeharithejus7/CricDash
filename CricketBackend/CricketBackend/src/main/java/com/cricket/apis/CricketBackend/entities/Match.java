package com.cricket.apis.CricketBackend.entities;
...
public class Match {
    ...
    public Match(int matchId, String teamHeading, String matchNumberVenue, String battingTeam, String battingTeamScore, String bowlTeam, String bowlTeamScore, String liveText, String matchLink, String testComplete, MatchStatus status, Date date) {
    ...
    public void setTestComplete(String textComplete) {
        this.textComplete = textComplete;
    }
